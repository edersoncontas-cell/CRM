...
export function AtendimentoClient({
  conversas, zapiAtiva, convInicial, maquinasProprias, colunasFunil,
}: {
  conversas: ConvLista[];
  zapiAtiva: boolean;
    ...
    >
      ...
      {novaNegoConv && (
        <FormNovaNegociacao
          ...
          clienteIdFixo={novaNegoConv.clienteId!}
          clienteNomeFixo={novaNegoConv.contactName || novaNegoConv.externalPhone}
