      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {msgs.map((m, i) => (
          <div key={i} className={`flex gap-3 ${m.role === "user" ? "justify-end" : "justify-start"}`}>
            ...
            <div
              className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed whitespace-pre-wrap ${m.role === "user" ? "rounded-tr-sm" : "rounded-tl-sm"}`}
              style={m.role === "user"
            ...
            >
              ...
              {m.content || (m.role === "assistant" && carregando && i === msgs.length - 1
