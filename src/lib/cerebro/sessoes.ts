...
export const LIGACOES: LigacaoSessao[] = [
  ...
  { de: "whatsapp", para: "alertas", fluxo: "conversa sem resposta vira alerta" },
  ...
  { de: "negociacoes", para: "dashboard", fluxo: "o funil vira meta e ritmo" },
  { de: "clientes", para: "dashboard", fluxo: "a carteira vira ranking e mapa do ES" },
  { de: "visitas", para: "dashboard", fluxo: "a visita feita conta na meta" },
